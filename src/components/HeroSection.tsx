...
const socialLinks = [
  { icon: Facebook, href: 'https://facebook.com/Mahmoud199', label: 'Facebook' },
  ...
  { icon: Linkedin, href: 'https://www.linkedin.com/in/mahmoud-m-209694024', label: 'LinkedIn' },
];
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <a href="/cv/mahmoud-cv.jpg" download>
                <Button
                  size="lg"
